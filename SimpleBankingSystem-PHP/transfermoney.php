...
<div class="container">
        <h2 class="text-left pt-4" style="color : #6c757d;">Transfer Money</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : gray;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color :  #c0c0c0;" style="border-radius:0%;">Proceed</button></a></td> 
                    </tr>
                <?php
                $cnt=$cnt+1;
                    }
         ...
         <footer class="text-center mt-5 py-2">
            <p>All rights are reservrd by <a href="">Kaushik Shukla</a> </p>
        </footer>
